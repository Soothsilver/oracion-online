...
;(function(){
     ...
     * @returns {*}
     */
    var generateNumber  = function(twister, min, max){
        ...
        return Math.floor(twister.random() * (max - min + 1) + min);
    };
     ...
     * @constructor
     */
    window.DiceRoller = function(twister){
        var lib = this;
        ...
        this.roll     = function(notation){
            ...
            if(notation){
                diceRoll = new DiceRoll(notation, twister);
     ...
     * @constructor
     */
    window.DiceRoll   = function(notation, twister){
        var lib = this;
        ...
        var diceRollMethods = {
            ...
            default:  function(sides){
                return generateNumber(twister,  1, sides);
            },
            /**
             * Rolls a fudge die
             *
